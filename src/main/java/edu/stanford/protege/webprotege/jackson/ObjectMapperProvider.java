...
public class ObjectMapperProvider implements Provider<ObjectMapper> {
    ...
    public ObjectMapper get() {
        ...
        module.addDeserializer(OWLEntity.class, new OWLEntityDeserializerBase<>(dataFactory));
        module.addDeserializer(OWLNamedIndividual.class, new OWLEntityDeserializerBase<>(dataFactory));
        ...
        module.addDeserializer(OWLDatatype.class, new OWLEntityDeserializerBase<>(dataFactory));
