 ...
 */
@JsonTest
public class OWLSymmetricObjectPropertyAxiom_Serialization_TestCase {
    ...
    private OWLSymmetricObjectPropertyAxiom axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLSymmetricObjectPropertyAxiom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("SymmetricObjectProperty");
