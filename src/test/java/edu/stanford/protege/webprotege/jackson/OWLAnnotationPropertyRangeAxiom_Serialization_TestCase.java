 ...
 */
@JsonTest
public class OWLAnnotationPropertyRangeAxiom_Serialization_TestCase {
    ...
    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLAnnotationPropertyRangeAxiom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("AnnotationPropertyRange");
        ...
        assertThat(json).extractingJsonPathStringValue("$.range").isEqualTo("http://example.org/A");
    }
    ...
    void shouldDeserializeAxiom() throws IOException {
        var json = """
                {
                    "@type" : "AnnotationPropertyRange",
                    "property" : {
                        "@type" : "AnnotationProperty",
                        "iri": "http://example.org/p"
                    },
                    "range" : "http://example.org/A"
                }
""";
