 ...
 */
@JsonTest
public class OWLDataSomeValuesFrom_Serialization_TestCase {
    ...
    private OWLDataSomeValuesFrom axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLDataSomeValuesFrom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("DataSomeValuesFrom");
