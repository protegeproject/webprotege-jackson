 ...
 */
@JsonTest
public class OWLObjectAllValuesFrom_Serialization_TestCase {
    ...
    private OWLObjectAllValuesFrom axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLObjectAllValuesFrom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("ObjectAllValuesFrom");
