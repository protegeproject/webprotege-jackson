 ...
 */
@JsonTest
public class OWLObjectExactCardinality_Serialization_TestCase {
    ...
    private OWLObjectExactCardinality axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLObjectExactCardinality(
                3,
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("ObjectExactCardinality");
