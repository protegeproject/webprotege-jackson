 ...
 */
@JsonTest
public class OWLInverseFunctionalObjectPropertyAxiom_Serialization_TestCase {
    ...
    private OWLInverseFunctionalObjectPropertyAxiom axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLInverseFunctionalObjectPropertyAxiom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("InverseFunctionalObjectProperty");
    ...
    void shouldDeserializeAxiom() throws IOException {
        var json = """
                {
                    "@type" : "InverseFunctionalObjectProperty",
                    "property" : {
                        "@type" : "ObjectProperty",
