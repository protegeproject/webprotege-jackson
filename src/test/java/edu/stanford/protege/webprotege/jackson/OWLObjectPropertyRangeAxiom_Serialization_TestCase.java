 ...
 */
@JsonTest
public class OWLObjectPropertyRangeAxiom_Serialization_TestCase {
    ...
    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLObjectPropertyRangeAxiom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("ObjectPropertyRange");
        ...
        assertThat(json).extractingJsonPathStringValue("$.range.['@type']").isEqualTo("Class");
