 ...
 */
@JsonTest
public class OWLFunctionalDataPropertyAxiom_Serialization_TestCase {
    ...
    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLFunctionalDataPropertyAxiom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("FunctionalDataProperty");
