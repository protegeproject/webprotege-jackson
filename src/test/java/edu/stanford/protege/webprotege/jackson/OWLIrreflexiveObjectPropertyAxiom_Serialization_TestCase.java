 ...
 */
@JsonTest
public class OWLIrreflexiveObjectPropertyAxiom_Serialization_TestCase {
    ...
    private OWLIrreflexiveObjectPropertyAxiom axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLIrreflexiveObjectPropertyAxiom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("IrreflexiveObjectProperty");
