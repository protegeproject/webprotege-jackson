 ...
 */
@JsonTest
public class OWLDataMaxCardinality_Serialization_TestCase {
    ...
    private OWLDataMaxCardinality axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLDataMaxCardinality(
                3,
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("DataMaxCardinality");
