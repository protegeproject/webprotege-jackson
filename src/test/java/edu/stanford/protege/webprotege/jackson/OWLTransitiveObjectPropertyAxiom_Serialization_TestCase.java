 ...
 */
@JsonTest
public class OWLTransitiveObjectPropertyAxiom_Serialization_TestCase {
    ...
    private OWLTransitiveObjectPropertyAxiom axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLTransitiveObjectPropertyAxiom(
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("TransitiveObjectProperty");
