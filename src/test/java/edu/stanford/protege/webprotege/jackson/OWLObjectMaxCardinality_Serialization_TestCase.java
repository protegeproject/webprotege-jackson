 ...
 */
@JsonTest
public class OWLObjectMaxCardinality_Serialization_TestCase {
    ...
    private OWLObjectMaxCardinality axiom;

    @BeforeEach
    void setUp() {
        axiom = dataFactory.getOWLObjectMaxCardinality(
                3,
    ...
    void shouldSerializeAxiom() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.['@type']").isEqualTo("ObjectMaxCardinality");
